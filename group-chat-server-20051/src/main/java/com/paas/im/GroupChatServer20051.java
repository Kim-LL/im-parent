...
public class GroupChatServer20051 implements CommandLineRunner {

    public static void main(String[] args) {
        SpringApplication.run(GroupChatServer20051.class, args);
    }
    ...
    public void run(String... args) throws Exception {
        log.info("GroupChatServer20051 -- args: {}", JSON.toJSONString(args));
