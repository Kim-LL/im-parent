...
public class DataServer20091 implements CommandLineRunner {

    public static void main(String[] args) {
        SpringApplication.run(DataServer20091.class, args);
    }
    ...
    public void run(String... args) throws Exception {
        log.info("DataServer20091 -- args: {}", JSON.toJSONString(args));
            ...
            executorService.execute(()->{
                for(ConsumerRecord<String, KafkaTransportObject> record : records){
                    try {
                        ...
                        log.error("ChatMsgConsumerHandler error:{}", e.getMessage());
                    }
                }
            });
        }
